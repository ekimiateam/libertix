...
install_live_installer_assets() {
    local -a assets=(
        ...
        "0755|$ROOT_DIR/assets/live/libertix-secure-boot-chain.py|/usr/local/lib/libertix/libertix-secure-boot-chain.py"
        "0755|$ROOT_DIR/assets/live/libertix-preferred-boot-path.py|/usr/local/lib/libertix/libertix-preferred-boot-path.py"
