...
load_libertix_installation_plan() {
    ...
    while IFS=$'\t' read -r name value; do
        case "$name" in
            INSTALLATION_PLAN_ID|INSTALLATION_FIRMWARE|DISTRIBUTION_ID|DISTRIBUTION_NAME|DISTRIBUTION_OS_RELEASE_ID|DISTRIBUTION_GRUB_DISPLAY_NAME|DISTRIBUTION_GRUB_ICON|\
            ...
            RECOVERY_ROOT_WINDOWS|RECOVERY_RUN_ID|LOW_MEMORY_MODE|LIVE_MINIMUM_MEMORY_MIB|INSTALLER_ALIGNMENT_BYTES|SHARE_WINDOWS_FILES_IN_LINUX|\
